...
-- Load VGG (small)
local prototxt = '/data/users/hz4213/FYP/VGG_CNN_M/VGG_CNN_M_deploy.prototxt' -- define prototxt path
local caffemodel='/data/users/hz4213/FYP/VGG_CNN_M/VGG_CNN_M.caffemodel' -- define caffemodel path
